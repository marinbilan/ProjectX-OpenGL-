...
namespace Shaders
{
class Shader_6 : public ShadersIf::ShadersIf
{
public:
	//
	//
	...
	//
	//	
	Shader_6(const char* vertexShader, const char* fragmentShader);
	...
	//
	//	
	friend std::ostream& operator<<(std::ostream& output, Shader_6& info)
	{
		output << "" << std::endl;
